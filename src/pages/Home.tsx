    ...
    <div className="space-y-8">
      ...
      <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white rounded-lg shadow-lg p-8 mb-8">
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="text-4xl font-bold mb-4">欢迎来到 OwerWeb</h1>
          <p className="text-xl mb-8">个人博客系统，支持文件管理、分类管理和内容发布</p>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a 
              href="/files" 
              className="bg-white text-blue-700 font-medium py-2 px-6 rounded-lg hover:bg-blue-50 transition duration-200"
            >
              管理文件
            </a>
            <a 
              href="/categories" 
              className="bg-transparent border-2 border-white text-white font-medium py-2 px-6 rounded-lg hover:bg-white hover:text-blue-700 transition duration-200"
            >
              管理分类
            </a>
          </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-200">
          ...
          <h3 className="text-xl font-semibold mb-2">文件上传系统</h3>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-200">
          ...
          <h3 className="text-xl font-semibold mb-2">内容分类系统</h3>
        ...
        <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-200">
          ...
          <h3 className="text-xl font-semibold mb-2">文件管理系统</h3>
